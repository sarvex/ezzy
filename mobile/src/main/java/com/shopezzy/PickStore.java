...
public class PickStore extends SherlockActivity {
	...
	AsyncHttpResponseHandler responseHandlerPush = new AsyncHttpResponseHandler() {
		...
		public void onSuccess(int arg0, Header[] arg1, byte[] arg2) {
			...
			try {
				String responseString = new String(arg2, "UTF-8");
				// Log.i(getClass().getSimpleName(), "Print... " +
				// responseString);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				...
				// Intent nextIntent = new Intent(PickStore.this,
				// SearchItems.class);
		...
		// ArrayList<Store> storesTotal = gson.fromJson(getIntent()
		// .getStringExtra("stores"), collectionType);

		// Log.i(getClass().getSimpleName(), "JSON is: "
		// + getIntent().getStringExtra("stores"));
		...
		if (!getIntent().hasExtra("stores")) {
			...
			try {
				...
				// Log.i(getClass().getSimpleName(), "Size: " + totalStores.pin
				// +
				// "-"
